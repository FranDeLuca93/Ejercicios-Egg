Algoritmo USE_SU_CEREBRO                                                                ///:3333333333333333333333333
	Definir tablero como Cadena
	Dimension tablero[9, 12]
	Escribir "MATRIZ INICIALIZADA"
	inicializarMatriz(tablero, 9, 12) //CHECK
	imprimirMatriz(tablero, 9, 12) //CHECK
	Esperar Tecla
	Limpiar Pantalla
	//CHECK
	...
	Escribir "MATRIZ ORGINAL" //CHECK
	imprimirMatriz(tablero, 9, 12) //CHECK
	Esperar Tecla
	Limpiar Pantalla
	
	Escribir "MATRIZ CAMBIADA (R)"
